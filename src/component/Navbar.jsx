...
function Navbar() {
  return (
    <nav className='w-full h-14 pt-0 flex justify-center flex-row  bg-gray-700 text-white pt-3px pb-3px space-x-4'>
        ...
        <a className='h-auto w-auto pl-1 pr-1 rounded-xl hover:bg-black items-center' href="">Courses</a>
        <a className=' h-auto w-auto pl-1 pr-1 rounded-xl hover:bg-black' href="">Practice</a>
        <a className='h-auto w-auto pl-1 pr-1 rounded-xl hover:bg-black ' href="">Roadmap</a>
       </div>
